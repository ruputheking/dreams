...
<li><a href="{{ route('generalcalls.index') }}">Phone Call Logs</a></li>
<li class="active">Update Phone Call Log</li>
@endsection
    ...
    <div class="col-md-4">
        <div class="panel panel-default no-export">
            <div class="panel-heading">
                <span class="panel-title">Update Phone Call Log</span>
            </div>
                ...
                <form method="post" autocomplete="off" action="{{route('generalcalls.update', $generalcall->slug)}}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('contact') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="contact" value="{{ $generalcall->contact }}" required>
                        </div>
                    </div>
