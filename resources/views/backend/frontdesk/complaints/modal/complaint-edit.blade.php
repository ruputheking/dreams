...
<form method="post" autocomplete="off" action="{{route('complaints.update', $complaint->slug)}}" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('image') ? ' has-error' : '' }}">
            ...
            <input type="file" name="image" class="form-control dropify" @if($complaint->image) data-default-file="/frontend/images/complaints/{{ $complaint->image }}"
            @endif data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG">
        </div>
    </div>
