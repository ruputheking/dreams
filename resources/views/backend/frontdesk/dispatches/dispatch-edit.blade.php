...
<li class="active">Update Postal Dispatch</li>
@endsection
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <span class="panel-title">Edit Postal Dispatch</span>
            </div>
            <div class="panel-body">
                <form method="post" autocomplete="off" action="{{route('dispatches.store', $dispatch->slug)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
