...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">Update Mark Distribution</div>

			<div class="panel-body">
				<form method="post" class="validate" autocomplete="off" action="{{route('mark_distributions.update', $id)}}" enctype="multipart/form-data">
					{{ csrf_field()}}
