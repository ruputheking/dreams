	...
	<div class="col-md-12">
		<div class="panel panel-default" data-collapsed="0">
			...
			<div class="panel-body">
				<div class="col-md-12">
					{!! Form::open(['method' => 'POST', 'route' => 'teacher.store_assignment','files' => TRUE, 'autocomplete' => 'off']) !!}
					...
					<div class="modal-footer clearfix">
						<div class="btn-group pull-right">
							...
							{!! Form::submit("Add Assignment", ['class' => 'btn btn-success', 'style' => 'margin-left:10px;']) !!}
						</div>
					</div>
					{!! Form::close() !!}
				</div>
