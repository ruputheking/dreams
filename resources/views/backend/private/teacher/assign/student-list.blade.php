                ...
                <table id="example1" class="table table-stripped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('assigned_student.show',[ $assignmentid = $data->topic_id, $studentid = $data->student_id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</a>
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['assigned_student.destory', $data->id]]) !!}
