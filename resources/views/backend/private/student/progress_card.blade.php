...
<li class="active">My Progress Card</li>
@endsection
				...
				<div class="panel panel-default" id="progress_card">
					...
					<div class="panel-body">
						<table class="table table-bordered">
							<tr>
								<td colspan="4" style="text-align:center;"><img width="100px" height="100px" style="border-radius: 8px; padding:5px; border:2px solid #ccc;" src="{{ asset('frontend/images/'.$student->photo) }}"></td>
							</tr>
							<tr>
								<td><b>School</b></td>
							...
							<tr>
								...
								<td colspan="3">{{ get_academic_year(get_option('academic_years')) }}</td>
							</tr>
						</table>
