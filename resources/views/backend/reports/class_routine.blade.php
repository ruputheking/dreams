	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form id="search_form" class="params-panel validate" action="{{ url('dashboard/reports/class_routine/view') }}" method="post" autocomplete="off" accept-charset="utf-8">
					@csrf
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<div class="form-group">
							<button type="submit" style="margin-top:38px;" class="btn btn-primary btn-block rect-btn">View Routine</button>
						</div>
					</div>
				</form>
				...
				<div class="col-md-12">
					<div class="panel panel-default" data-collapsed="0">
						<div class="panel-heading">
							<span class="panel-title">
								{{ ('Class Routine Of') }} {!! ('Class')." <b>". $class->class_name."</b>" !!} {!! ('Section')." <b>".$section->section_name."</b>" !!}
							</span>
							<button type="button" data-print="classic_routine" class="btn btn-primary btn-sm pull-right print"><i class="fa fa-print"></i> Print Routine</button>
						</div>
						<div class="panel-body">
							<div class="col-md-12">
											...
											<tbody>
												<tr>
													<td colspan="100" class="text-center">
														...
														<span class="f-18">Class: {{ $class->title }}</span> |
