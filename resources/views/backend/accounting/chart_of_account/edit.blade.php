...
<li class="active">Update Chart Of Account</li>
@endsection
...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">Update Chart Of Account</div>

			<div class="panel-body">
				<form method="post" class="validate" autocomplete="off" action="{{route('chart_of_accounts.update', $id)}}" enctype="multipart/form-data">
					{{ csrf_field()}}
