...
<li class="active">List Income</li>
@endsection
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><span class="panel-title">List Income</span>
				<a class="btn btn-primary btn-sm pull-right" data-title="Add Income" href="{{ route('transactions.add_income') }}" style="margin-top:-3px">Add New</a>
			</div>
