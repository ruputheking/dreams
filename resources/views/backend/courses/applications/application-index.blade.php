                        ...
                        <table id="example1" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('courseappications.show', $data->id)}}" class="btn btn-warning btn-xs"><i class="fa fa-eye"></i> View</a>
                                        <!-- Delete Button -->
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['courseappications.destroy', $data->id]]) !!}
