                ...
                <form action="{{route('subjects.store')}}" class="validate" autocomplete="off" method="post" accept-charset="utf-8">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="full_mark" value="{{ old('full_mark') }}" placeholder="Full Mark">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label class="control-label">Pass Mark</label>
                            <input class="form-control" type="text" name="pass_mark" value="{{ old('pass_mark') }}" placeholder="Pass Mark">
                        </div>
                    </div>
                    <div class="col-sm-12">
