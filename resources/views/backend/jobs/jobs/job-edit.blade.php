    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="post" class="validate" autocomplete="off" action="{{ route('jobs.update', $job->slug) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group col-md-12 {{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input id="title" type="text" class="form-control" name="title" value="{{ $job->title }}" placeholder="Job title" required>
                            </div>
                            <div class="form-group col-md-12 {{ $errors->has('slug') ? ' has-error' : '' }}">
                                <label class="control-label">Slug <span class="required">*</span></label>
                                <input id="slug" type="text" class="form-control" name="slug" value="{{ $job->slug }}" placeholder="Job Slug" required>
                            </div>
                            <div class="form-group col-md-12 {{ $errors->has('summary') ? ' has-error' : '' }}">
                                ...
                                <textarea class="form-control" rows="4" name="summary" placeholder="Job summary">{{ $job->summary }}</textarea>
                            </div>
                            <div class="form-group col-md-12 {{ $errors->has('details') ? ' has-error' : '' }}">
                                ...
                                <textarea class="form-control summernote" name="details">{{ $job->details }}</textarea>
                            </div>
                            <div class="form-group col-md-12 mt-10">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                    <div class="col-md-12 {{ $errors->has('seo_meta_keywords') ? ' has-error' : '' }}">
                                        ...
                                        <textarea type="text" class="form-control" name="seo_meta_keywords" value="{{ $job->seo_meta_keywords }}" placeholder="Meta Keywords"></textarea>
                                    </div>
                                    <div class="col-md-12 mb-15 {{ $errors->has('seo_meta_description') ? ' has-error' : '' }}">
                                        <label class="control-label">Meta Description</label>
                                        <textarea type="text" class="form-control" name="seo_meta_description" value="{{ $job->seo_meta_description }}" placeholder="Meta Description"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control select2" name="status">
                                    ...
                                    <option @if($job->status == '1') selected
                                        @endif value="1">Active
                                    </option>
                                    <option @if($job->status == '0') selected
                                        @endif value="0">Draft
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="number" class="form-control" name="candidate" value="{{ decimalPlace($job->candidate) }}" placeholder="Total Candidate">
                            </div>
                            <div class="form-group col-md-12">
                                <label class="control-label">Salary (Rs)</label>
                                <input type="text" class="form-control" name="salary" value="{{ $job->salary ?? 'Negotiable' }}" placeholder="Defualt Negotiable">
                            </div>
                            <div class="form-group col-md-12 {{ $errors->has('deadline') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control datetimepicker" name="deadline" value="{{ $job->deadline }}" placeholder="Deadline" required>
                            </div>
