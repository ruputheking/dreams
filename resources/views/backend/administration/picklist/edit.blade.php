...
<li class="active">Update Religion</li>
@endsection
	...
	<div class="col-md-4">
		<div class="panel panel-default" data-collapsed="0">
			...
			<div class="panel-body">
				<form action="{{route('picklists.update', $picklist->id)}}" class="form-horizontal validate" enctype="multipart/form-data" method="post" autocomplete="off" accept-charset="utf-8">
					{{ csrf_field() }}
					{{method_field('patch')}}
					<div class="form-group">
						<div class="col-md-12">
							<label class="control-label">Religion <span class="required">*</span></label>
							<input type="text" class="form-control" name="value" value="{{ $picklist->value }}" placeholder="Religion Name" required>
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-12">
