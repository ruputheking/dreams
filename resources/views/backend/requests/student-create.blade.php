        ...
        <div class="panel panel-default" data-collapsed="0">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <form action="{{route('user_requests.store')}}" autocomplete="off" class="form-group" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        {{csrf_field()}}
                        ...
                        <a style="margin-top:6px" href="{{route('user_parents.create')}}" data-title="Add New Parent" class="btn btn-primary btn-sm ajax-modal"><i class="fa fa-plus"></i>Quick Add</a>
                        ...
                        <div class="col-md-12 {{ $errors->has('image') ? ' has-error' : '' }}">
                            <label class="control-label">Profile Picture <span class="required">*</span></span></label>
                            <input type="file" class="form-control dropify" name="image" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG">
                        </div>

                        <div class="col-sm-5" style="margin-top:20px;">
                            <button type="submit" class="btn btn-info">Send Student Request</button>
                        </div>
                    </form>
                </div>
            </div>
