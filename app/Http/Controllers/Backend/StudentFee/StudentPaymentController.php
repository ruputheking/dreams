...
class StudentPaymentController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if ($validator->fails()) {
			if($request->ajax()){
				...
				return redirect('dashboard/student_payments/create')
		...
		if(! $request->ajax()){
           return redirect('dashboard/student_payments/create')->with('success', 'Information has been added sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'store2','message'=>'Information has been added sucessfully','data'=>$studentpayment]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('dashboard/student_payments')->with('success', 'Information has been updated sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'Information has been updated sucessfully','data'=>$studentpayment]);
		}
    ...
    public function destroy($id)
    {
        ...
        return redirect('dashboard/student_payments')->with('success', 'Information has been deleted sucessfully');
    }
}
