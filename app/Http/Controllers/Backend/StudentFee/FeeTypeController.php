...
class FeeTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if ($validator->fails()) {
			if($request->ajax()){
				...
				return redirect('dashboard/fee_types/create')
		...
		if(! $request->ajax()){
           return redirect('dashboard/fee_types/create')->with('success', 'Information has been added sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>'Information has been added sucessfully','data'=>$feetype]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('dashboard/fee_types')->with('success', 'Information has been updated sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'Information has been updated sucessfully','data'=>$feetype]);
		}
    ...
    public function destroy($id)
    {
        $feetype = FeeType::find($id);
        $feetype->delete();
        return redirect('dashboard/fee_types')->with('success', 'Information has been deleted sucessfully');
    }
}
