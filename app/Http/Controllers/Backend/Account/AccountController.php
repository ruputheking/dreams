...
class AccountController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if(! $request->ajax()){
           return redirect('dashboard/accounts/create')->with('success', 'Information has been added sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>'Information has been added sucessfully','data'=>$account]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('accounts')->with('success', 'Information has been updated sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'Information has been updated sucessfully','data'=>$account]);
		}
    ...
    public function destroy($id)
    {
        $account = Account::find($id);
        $account->delete();
        return redirect('accounts')->with('success','Information has been deleted sucessfully');
    }
}
