...
class GradeController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if ($validator->fails()) {
			if($request->ajax()){
				...
				return redirect('dashboard/grades/create')
		...
		if(! $request->ajax()){
           return redirect('dashboard/grades/create')->with('success', 'Information has been added sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=> 'Information has been added sucessfully','data'=>$grade]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('grades')->with('success', 'Information has been updated sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=> 'Information has been updated sucessfully','data'=>$grade]);
		}
    ...
    public function destroy($id)
    {
        $grade = Grade::find($id);
        $grade->delete();
        return redirect('grades')->with('success', 'Information has been deleted sucessfully');
    }
}
