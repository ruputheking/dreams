...
class MarkDistributionController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if ($validator->fails()) {
			if($request->ajax()){
				...
				return redirect('dashboard/mark_distributions/create')
		...
		if(! $request->ajax()){
           return redirect('dashboard/mark_distributions/create')->with('success', 'Information has been added sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>'Information has been added sucessfully','data'=>$markdistribution]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('mark_distributions')->with('success', 'Information has been updated sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'Information has been updated sucessfully','data'=>$markdistribution]);
		}
    ...
    public function destroy($id)
    {
        ...
        return redirect('mark_distributions')->with('success', 'Information has been deleted sucessfully');
    }
}
