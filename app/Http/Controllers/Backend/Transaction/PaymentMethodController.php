...
class PaymentMethodController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if ($validator->fails()) {
			if($request->ajax()){
				...
				return redirect('dashboard/payment_methods/create')
		...
		if(! $request->ajax()){
           return redirect('dashboard/payment_methods/create')->with('success', 'Information has been added sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>'Information has been added sucessfully','data'=>$paymentmethod]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('dashboard/payment_methods')->with('success', 'Information has been updated sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'Information has been updated sucessfully','data'=>$paymentmethod]);
		}
    ...
    public function destroy($id)
    {
        ...
        return redirect('dashboard/payment_methods')->with('success', 'Information has been deleted sucessfully');
    }
}
