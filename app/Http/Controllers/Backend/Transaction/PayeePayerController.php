...
class PayeePayerController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if ($validator->fails()) {
			if($request->ajax()){
				...
				return redirect('dashboard/payee_payers/create')
		...
		if(! $request->ajax()){
           return redirect('dashboard/payee_payers/create')->with('success', 'Information has been added sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>'Information has been added sucessfully','data'=>$payeepayer]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('dashboard/payee_payers')->with('success', 'Information has been updated sucessfully');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'Information has been updated sucessfully','data'=>$payeepayer]);
		}
    ...
    public function destroy($id)
    {
        $payeepayer = PayeePayer::find($id);
        $payeepayer->delete();
        return redirect('dashboard/payee_payers')->with('success', 'Information has been deleted sucessfully');
    }
}
